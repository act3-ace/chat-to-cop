...
#SBATCH --output=c2c-14b-B_%j.out
#SBATCH --error=c2c-14b-B_%j.err
#
# =============================================================================
# Issue #52: Run B — WITHOUT speaker models (Qwen2.5-14B, 8K context, V100)
# =============================================================================
#
# This is the SECOND HALF of the A/B experiment. Run A (with speakers)
# should have already completed. Settings are IDENTICAL to Run A except:
#   CHAT_TO_COP_USE_SPEAKER_MODELS=false
#
# 8-hour walltime to match Run A. Results archived to $ARCHIVE_HOME.
# =============================================================================
...
JOB_ID="${SLURM_JOB_ID:-$$}"
DB_PATH="$OUTPUT_DIR/replay_14b_without_speakers_${JOB_ID}.db"
LOG_FILE="$OUTPUT_DIR/replay_14b_runB_${JOB_ID}.log"
...
echo "=============================================================================="
echo "Chat-to-CoP: 14B Run B — WITHOUT Speaker Models (#52)"
echo "=============================================================================="
echo "Job ID:     $JOB_ID"
echo "Node:       $(hostname)"
...
cleanup() {
    ...
    for f in "$WORK/chat-to-cop/c2c-14b-B_${JOB_ID}".{out,err}; do
...
echo "Output DB:   $DB_PATH"
echo ""
echo "Next step: Download both databases and run comparison:"
